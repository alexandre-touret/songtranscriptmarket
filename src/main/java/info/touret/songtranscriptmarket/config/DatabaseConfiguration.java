...
@EnableMongoRepositories("info.touret.songtranscriptmarket.repository")
...
public class DatabaseConfiguration {
    ...
    public Mongobee mongobee(Mongo mongo, MongoProperties mongoProperties) {
        ...
        mongobee.setChangeLogsScanPackage("info.touret.songtranscriptmarket.config.dbmigrations");
