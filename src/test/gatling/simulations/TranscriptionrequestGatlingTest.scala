 ...
 */
class TranscriptionrequestGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Transcriptionrequest entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all transcriptionrequests")
            .get("/api/transcriptionrequests")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created transcriptionrequest")
                .get("${new_transcriptionrequest_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created transcriptionrequest")
            .delete("${new_transcriptionrequest_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
